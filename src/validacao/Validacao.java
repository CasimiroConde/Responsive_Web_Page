...
public class Validacao {
	 ...
	 * @return
	 */
	public static boolean validaSolucao(Solucao solucao, double larguraTela, Modelo modelo){
		if(/*validaLargura(solucao, larguraTela) &&*/ validaRelacoes(solucao, modelo))
			return true;
		return false;
	}
	 ...
	 * @return
	 */
	public static boolean validaLargura(Solucao solucao, double larguraTela){
		return solucao.calculaLarguraRealSolucao() < larguraTela;
	}
